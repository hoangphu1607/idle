...
export const HERO_SKILL_INFO = {
    ...
    mage_skill_second: {
        name: "Mage Firestorm",
        icon: "Mage_second_skill",
        description: "Gọi một cơn bão lửa gây 180% sát thương phép lên mục tiêu và các ô xung quanh (3x3).",
    },
    nature_skill_first: {
        name: "Nature Heal",
    ...
    nature_skill_second: {
        name: "Nature Growth",
        icon: "Nature_second_skill",
        description: "Tạo 1 vòng hồi phục cho đồng minh trong 4 giây. Mỗi giây hồi 10 HP x số stack (tối đa 3 stack).",
    },
};
